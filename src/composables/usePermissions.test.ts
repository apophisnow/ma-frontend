...
describe('usePermissions', () => {
  ...
  it('fetchPermissions populates permissions and toggles loading', async () => {
    const payload = [
      { id: 'adjust_volume', name: 'Adjust Volume', description: 'Adjust player volume', patterns: ['players/cmd/volume_*'] },
    ];
    (api.sendCommand as unknown as ReturnType<typeof vi.fn>).mockResolvedValueOnce(payload);
